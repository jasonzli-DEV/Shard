 ...
 * Login page.
 *
 * Layout: left panel (brand/display type) + right panel (auth actions).
 * The crystal mark is the visual anchor; type does the heavy lifting.
 */
      ...
      <aside className="login-brand">
        <div className="login-brand-inner">
          ...
          <ul className="login-features" aria-label="Key features">
            <li>Self-hosted on Atlas M0</li>
            <li>Per-user auto-scaling</li>
        ...
        <div className="login-form">
          ...
          <div className="login-providers">
            ...
            <a
              ...
              className="login-provider-btn login-provider-github"
